...
function PathtracingRenderer(canvas, useControls) {
    ...
    this.loadIBL = function (ibl) {
        new RGBELoader().setDataType(THREE.FloatType).load(ibl, function (texture) {
        ...
        new RGBELoader()
            ...
            .load(ibl_path, function (texture) {
                ...
                loader.load(scene_path, function (gltf) {
                    ...
                    texture.flipY = true;
                    texture.needsUpdate = true;
                    _this.useIBL(_useIBL);
                    _this.useBackgroundFromIBL(_backgroundFromIBL);
