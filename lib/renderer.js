...
function PathtracingRenderer(canvas, useControls) {
  ...
  this.disableDirectShadows = function (flag) {
    _disableDirectShadows = flag;
    _this.resetAccumulation();
  }
  ...
  this.useBackgroundFromIBL = function (flag) {
    _backgroundFromIBL = flag
    if (flag) {
      _scene.background = _glCubeIBL;
    } else {
      _scene.background = new THREE.Color(1, 1, 1);
    }
    _this.resetAccumulation();
  }
    ...
    function renderFrame() {
      ...
      if (_usePathtracing) {
        ...
        if (_pathTracingUniforms !== undefined) {
          ...
          _pathTracingUniforms.u_bool_BackgroundFromIBL.value = _backgroundFromIBL;
          ...
          _pathTracingUniforms.u_bool_disableDirectShadows.value = _disableDirectShadows;
  ...
  async function prepareDataBuffers(meshList, lightList, materialBuffer, materialTextureInfoBuffer, triangleMaterialMarkers) {
    ...
    _pathTracingUniforms = {
      ...
      u_bool_BackgroundFromIBL: { type: "b", value: true },
