...
function PathtracingRenderer(parameters, settings) {
    ...
    this.toggleBackgroundFromIBL = function(flag) {
      _this.settings.backgroundFromIBL = flag
      if(flag) {
    ...
    this.enableControls = function(flag) {
        _controls.enabled = flag;
    }
        ...
        function renderFrame() {
            ...
            if (_this.settings.pathtracing) {
                ...
                if (_pathTracingUniforms !== undefined) {
                    ...
                    _pathTracingUniforms.u_bool_BackgroundFromIBL.value = _this.settings.backgroundFromIBL;
        ...
        new RGBELoader()
            ...
            .load(ibl_path, function (texture) {
                ...
                loader.load(scene_path, function (gltf) {
                    ...
                    _this.toggleBackgroundFromIBL(_this.settings.backgroundFromIBL);
